...
test() ->
	...
	Grid = path_finding_grid:path_finding_grid(100, 100),
    Grid3 = path_finding_grid:setWalkableAt(14, 15 ,false, Grid),

	jump_point_finder:finder(16, 15, 13, 15, #path_finding_finder{diagonal_movement = ?DM_Always, heuristic = ?Heuristic_Euclidean}, Grid3).
